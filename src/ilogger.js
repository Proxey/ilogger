(function() {
    ...
    var realLog = function (level, message, source) {
        ...
        var now;
        if(config.millis) {
            now = moment(config.millis);
        } else {
            now = moment();
        }
        var logString = now.format(config.dateTimePattern) + " " + levelString + " [" + source + "] " + message;
        write(logString);
    ...
    Logger.setDateTimePattern = function(dateTimePattern) {
        config.dateTimePattern = dateTimePattern;
    };

    Logger.setMillis = function(millis) {
